...
![](reference/figures/README-spo_hand.png)
...
reports which products exist and how many features each one has.
...
[`read_sgb()`](https://pedreirajr.github.io/geohazards/reference/read_sgb.md)
returns the requested product as an `sf` object in SIRGAS 2000
(EPSG:4674). The default product is the risk sectorisation, with every
risk level mapped by the SGB.
...
![](reference/figures/README-sgb-map-1.png)
