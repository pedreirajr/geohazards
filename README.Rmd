...
```{r sgb-map, cache = TRUE, dependson = "sgb-risk", fig.width = 8, fig.height = 5}
library(ggplot2)
...
Important: the SGB mapping is not universal. A municipality with no features comes
